                ...
                try:
                    ...
                    if hf_token:
                        ...
                        try:
                            ...
                            print(f"❌ Loading without token also failed: {no_token_error}")
                            raise RuntimeError(f"Failed to load processor: {no_token_error}")
                    else:
                        raise RuntimeError(f"Failed to load processor: {token_error}")
